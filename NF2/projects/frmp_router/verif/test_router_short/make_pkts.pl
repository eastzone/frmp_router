...
add_LPM_table_entry(62,'171.64.2.0', '255.255.255.0', '171.64.2.1', 0x04);
#add_LPM_table_entry(3, '0.0.0.0', '0.0.0.0', '171.64.1.1', 0x01);

# Add the ARP table entries
add_ARP_table_entry(0, '171.64.1.1', $next_hop_1_DA);
add_ARP_table_entry(31, '171.64.2.1', $next_hop_2_DA);
